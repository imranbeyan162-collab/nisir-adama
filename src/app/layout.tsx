...
import { LanguageWelcomeSplash } from '@/components/common/LanguageWelcomeSplash';

export const metadata: Metadata = {
  title: 'Nisir Football Academy — Adama, Ethiopia | Better Dream Better Life',
  description:
    'Official website and registration portal for Nisir Football Academy in Adama at Chapi Stadium. Elite youth training, academic excellence, and discipline since 2013 E.C.',
  icons: {
    icon: '/nisir-logo.png',
