...
async function main() {
  ...
  const settings = [
    ...
    { key: 'training_ground', value: 'Chapi Meda / Chapi Stadium, Adama', group: 'location' },
    ...
    { key: 'location_directions_1', value: `Located at Chapi Meda / Chapi Stadium in Adama at GPS Coordinates: 8°33'56.9"N 39°15'56.2"E.`, group: 'location' },
  ...
  const mediaItems = [
    {
      ...
      subtitle: 'Forging disciplined champions, elite technical footballers, and top-ranking academic scholars at Chapi Stadium since 2013 E.C.',
      mediaType: 'video',
      ...
      caption: 'Chapi Stadium Morning Cohort Session',
    },
    {
      sectionKey: 'about_covid_1',
      page: 'about',
      title: 'Masked Drills at Chapi Meda (2013 E.C.)',
    ...
    },
    {
      ...
      caption: 'Coach Fisha Welde Meskel at Chapi Stadium, Adama.',
    },
    {
  ...
  const galleryItems = [
    {
      title: 'Chapi Stadium Championship Match',
    ...
    },
    {
      ...
      description: 'Historic photo of early cohort maintaining health protocols at Chapi Meda during the 2020 pandemic.',
      mediaType: 'photo',
    ...
    },
    {
      ...
      description: 'Curled free kicks and penalty box clinical finishing at Chapi Stadium.',
      mediaType: 'video',
      mediaUrl: 'https://assets.mixkit.co/videos/preview/mixkit-soccer-player-kicking-a-ball-in-a-stadium-41121-large.mp4',
